...
extension RBCivicToolkitStore {
    ...
    func ensureTownSquareProjectPresent() {
        ...
        • Site-plan / special-permit hearing: special meeting June 10, 2026 at 6:00 p.m.
        ...
        • RiverheadLOCAL reported a 3-2 Town Board vote to set a May 20, 2026 public hearing on proposed condemnation of the Long Island Science Center building at 111 East Main Street; following that hearing, the Town Board voted on June 3, 2026 to begin condemnation proceedings (likely the EDPL §207 trigger date)
