...
struct RiverheadAIService {
    ...
    private func accountingStandardsGuidance() -> String {
        [
            ...
            "- When discussing fund balance, explain that restricted, assigned, and unassigned amounts are not interchangeable. Do not imply that all fund balance is freely spendable.",
            "- Be careful with one-time resources. Do not present one-time fund balance, asset sales, or temporary financing as a structurally recurring solution for recurring operating costs.",
            "- When the user asks about financial health, discuss recurring revenues versus recurring expenditures, reserve levels, liquidity, debt burden, and operational sustainability.",
            ...
            "- If a question involves recognition timing, explain that cash timing and accounting recognition may differ, and that final treatment depends on the Town's audited statements and accounting policies.",
            ...
            "- When possible, suggest the most relevant official source to verify: adopted budget, audited financial statements, notes to the financials, bond documents, or Town staff."
        ]
        .joined(separator: "\n")
    }
