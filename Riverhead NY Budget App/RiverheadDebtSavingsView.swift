...
struct RiverheadDebtSavingsView: View {
    ...
    private var debtMetrics: [DebtMetric] {
        [
            .init(
                title: "Bonded debt",
                value: "$43.96M",
                note: "2024 audit, excluding BANs and premiums.",
    ...
    private var sourceNote: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Text("Debt figures are based on Riverhead's 2024 audited financial statements: $43,959,898 bonded debt excluding BANs and premiums, $22,800,000 in BANs, $66,759,898 total including BANs, and 6.74% of debt limit exhausted. Policy framing is based on GASB debt and OPEB disclosure concepts, GASB 54-style fund-balance discipline, and GFOA debt-management and capital-planning best practices.")
                .font(.footnote)
                .foregroundStyle(.secondary)
                .fixedSize(horizontal: false, vertical: true)
        }
